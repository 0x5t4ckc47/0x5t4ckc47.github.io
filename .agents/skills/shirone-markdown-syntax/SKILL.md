...
Reference implementation and copyable examples: `src/plugins/markdown/manifest.json` and `docs/markdown-extensions.md`, plus the content-repository demo article for field cards.
